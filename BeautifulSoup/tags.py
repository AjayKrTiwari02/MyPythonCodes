...
with open ("sample.html","r") as f:        # r->read mode
    html_doc=f.read()
...
# s=soup.find(id="link3")
# print(s.get("href"))
# print(soup.select("div.italic"))      #.italic-> italic class
# print(soup.select("span#italic"))     # #italic-> italic id
...
# with open("modified41.html","w") as f:
#     f.write(str(soup))
